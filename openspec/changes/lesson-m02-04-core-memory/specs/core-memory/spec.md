<!-- Delta spec for the ENGINE capability graduated by this lesson: core-memory.
     Merges into openspec/specs/core-memory/ at archive. Requirements describe observable
     behavior, not specific procedure names, so they hold regardless of the packaging/naming
     the learner chooses in design.md. The lesson's tests trace to these scenarios. -->
