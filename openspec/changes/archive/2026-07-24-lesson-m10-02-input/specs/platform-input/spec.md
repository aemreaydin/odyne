<!-- Delta spec for the ENGINE capability built by this lesson: platform-input.
     Merges into openspec/specs/platform-input/ at archive. Requirements describe observable
