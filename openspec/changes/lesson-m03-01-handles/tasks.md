...
- [x] 1.1 [tutor] Verify + register cite-keys FLOOOH, BITSQUID, ZYL-HANDLES in BIBLIOGRAPHY.md; write lesson.md
- [x] 1.2 [you] Read lesson.md and the required reading ([FLOOOH] whole article, [BITSQUID] whole post); note questions
...
- [x] 3.1 [tutor] Run the measurement task (dense-array vs handle-resolve vs pointer-chase vs map lookup, `katas/handles_bench/`); record Built + Measured in curriculum/JOURNAL.md
...
- [x] 3.4 [tutor] Copy lesson.md → curriculum/modules/m03/m03-01-handles/LESSON.md
- [x] 3.5 [tutor] Update curriculum/curriculum.yaml (m03-01 → done; m03-02 → available; clear active_change)
