<!-- Delta spec for the ENGINE capability built by this lesson: platform-window.
     Merges into openspec/specs/platform-window/ at archive. Requirements describe observable
